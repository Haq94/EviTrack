...
filtering_plot.py
==================
Standalone script: seed-aggregated DD-aligned filtering metric plots + pre/post tables.
Filtering metrics have no horizon dimension.
Produces one figure per metric, with 1 x n_bins subplots (one per DD bin).
Run directly: python filtering_plot.py
"""
...
# =============================================================================
# METRIC CONFIGS
# NOTE: latent_bias is stored as raw signed bias; we square it at load time.
# =============================================================================
METRIC_CONFIGS = {
    "mse":      {"key": "latent_mse",      "name": "Filtering MSE",      "ylabel": "MSE",       "clip": None, "ylim": None,        "transform": None},
    "bias_sq":  {"key": "latent_bias",     "name": "Filtering Bias$^2$", "ylabel": "Bias$^2$",  "clip": None, "ylim": None,        "transform": "square"},
    "variance": {"key": "latent_variance", "name": "Filtering Variance", "ylabel": "Variance",  "clip": None, "ylim": None,        "transform": None},
}
...
def main():
    ...
    # Filtering metrics have no horizon dimension — always organize at horizon_idx=0
    ...
    for metric_key_name in METRICS:
        ...
        # --- PLOT ---
        save_stem = Path(SAVE_DIR) / "filtering_plots" / f"{FIGURE_NAME}_{metric_key_name}_bins"
        plot_bins(
